...
describe('Admin', () => {
    ...
    // Submitting the form with invalid data types
    it('should not submit the form with invalid data types', () => {
      const wrapper = mount(<Admin />);
      const form = wrapper.find('form');
      const priceInput = wrapper.find('input[name="price"]');
      priceInput.simulate('change', { target: { name: 'price', value: 'abc' } });
