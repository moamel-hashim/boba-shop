...
describe('Admin', () => {
    ...
    // Renders the NewDrink component when the path is '/admin'
    it('should render the NewDrink component when the path is "/admin"', () => {
      const wrapper = mount(
        <MemoryRouter initialEntries={['/admin']}>
          <Admin />
        </MemoryRouter>
      );
      expect(wrapper.find(NewDrink)).toHaveLength(1);
    });
});
